...
def test_invite_auth_user_id_invalid(clear_store):
    auth_user_id = create_user
    u_id = create_user2
    channel_id_dict_1 = channels_create_v1(auth_user_id, 'Channel1', True)
    with pytest.raises(AccessError):
        channel_invite_v1(None, channel_id_dict_1['channel_id'], u_id)
...
def test_invite_error_invalid_channel(clear_store):
    ...
    with pytest.raises(InputError):
        channel_invite_v1(auth_user_id, None, u_id_1)
...
def test_invite_error_invalid_user(clear_store):
    ...
    channel_id_dict = channels_create_v1(auth_user_id, 'Channel1', True)
    with pytest.raises(InputError):
        channel_invite_v1(auth_user_id, channel_id_dict['channel_id'], None)
