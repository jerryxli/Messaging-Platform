...
def test_owner_addowner(clear_store, create_user, create_user2):
    ...
    channel_details_1 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_2}, json = {'token': user_token_1}).json()
    channel_details_2 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_1}, json = {'token': user_token_2}).json()
...
def test_global_owner_add_themselves(clear_store, create_user, create_user2):
    ...
    channel_details = requests.get(DETAILS_URL, params = {'channel_id': channel_id_2}, json = {'token': user_token_1}).json()
...
def test_global_owner_add_others(clear_store, create_user, create_user2, create_user3):
    ...
    channel_details = requests.get(DETAILS_URL, params = {'channel_id': channel_id_2}, json = {'token': user_token_2}).json()
...
def test_member_addowner(clear_store, create_user, create_user2, create_user3):
    ...
    join_response2 = requests.post(JOIN_URL, json = {'token': user_token_3, 'channel_id': channel_id_1})
    response_1 = requests.post(ADDOWNER_URL, json = {'token': user_token_2, 'channel_id': channel_id_1, 'u_id': create_user3['auth_user_id']})
    response_2 = requests.post(ADDOWNER_URL, json = {'token': user_token_3, 'channel_id': channel_id_1, 'u_id': create_user2['auth_user_id']})
...
def test_unauthorised_member(clear_store, create_user, create_user2, create_user3):
    ...
    request_data_1 = requests.post(ADDOWNER_URL, json = {'token': user_token_1, 'channel_id': channel_id_1, 'u_id': create_user3['auth_user_id']})
    request_data_2 = requests.post(ADDOWNER_URL, json = {'token': user_token_2, 'channel_id': channel_id_2, 'u_id': create_user2['auth_user_id']})
