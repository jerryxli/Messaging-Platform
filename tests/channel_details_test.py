...
def test_creator_of_channel(clear_store, create_user, create_user2):
    ...
    channel_details_1 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_1}, json = {'token': user_token_1}).json()
    channel_details_2 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_2}, json = {'token': user_token_2}).json()
...
def test_member_of_public_channel(clear_store, create_user, create_user2):
    ...
    channel_details_1 = requests.get(DETAILS_URL, params = {'channel_id': channel_id}, json = {'token': user_token_1}).json()
    channel_details_2 = requests.get(DETAILS_URL, params = {'channel_id': channel_id}, json = {'token': user_token_2}).json()
...
def test_unauthorised_user_id(clear_store, create_user, create_user2, create_user3):
    ...
    channel_id_1 = requests.post(CREATE_URL, json = {'token': user_token_1, 'name': 'My Channel!', 'is_public': True}).json()['channel_id']
    channel_id_2 = requests.post(CREATE_URL, json = {'token': user_token_2, 'name': 'kitchen', 'is_public': False}).json()['channel_id']
    request_data_1 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_1}, json = {'token': user_token_2})
    request_data_2 = requests.get(DETAILS_URL, params = {'channel_id': channel_id_2}, json = {'token': user_token_3})
    # Access Error
...
def test_invalid_channel_id(clear_store, create_user, create_user2):
    ...
    user_token_2 = create_user2['token']
    channel_id = 0
    request_data_1 = requests.get(DETAILS_URL, params = {'channel_id': channel_id}, json = {'token': user_token_1})
    request_data_2 = requests.get(DETAILS_URL, params = {'channel_id': channel_id}, json = {'token': user_token_2})
    # Input Error
...
def test_from_stub_code(clear_store, create_stub_user):
    ...
    channel_details = requests.get(DETAILS_URL, params = {'channel_id': channel_id}, json = {'token': stub_token})
