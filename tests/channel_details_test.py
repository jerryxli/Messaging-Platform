...
@pytest.fixture
def create_user():
    user_id = auth_register_v1("z432324@unsw.edu.au", "password",
                               "Name", "Lastname")['auth_user_id']
    return user_id
...
def test_creator_of_channel(clear_store, create_user, create_user2):
    ...
    assert is_valid_dictionary_output(channel_details_v1(user_id_1, channel_id_1), {'name': str, 'is_public': bool, 'owner_members': list, 'all_members': list})
    ...
    assert is_valid_dictionary_output(channel_details_v1(user_id_2, channel_id_2), {'name': str, 'is_public': bool, 'owner_members': list, 'all_members': list})
...
def test_member_of_public_channel(clear_store, create_user, create_user2):
    ...
    assert is_valid_dictionary_output(channel_details_v1(user_id_1, channel_id), {'name': str, 'is_public': bool, 'owner_members': list, 'all_members': list})
    ...
    assert is_valid_dictionary_output(channel_details_v1(user_id_2, channel_id), {'name': str,'is_public': bool, 'owner_members': list, 'all_members': list})
