...
def test_creator_of_channel(clear_store, create_user, create_user2):
    ...
    channel_details_2 = requests.get(DETAILS_URL, params={'channel_id': channel_id_2, 'token': user_token_2}).json()
...
def test_member_of_public_channel(clear_store, create_user, create_user2):
    ...
    channel_details_1 = requests.get(DETAILS_URL, params={'channel_id': channel_id, 'token': user_token_1}).json()
    channel_details_2 = requests.get(DETAILS_URL, params={'channel_id': channel_id, 'token': user_token_2}).json()
...
def test_from_stub_code(clear_store, create_stub_user):
    ...
    channel_details = requests.get(DETAILS_URL, params={'channel_id': channel_id, 'token': stub_token})
